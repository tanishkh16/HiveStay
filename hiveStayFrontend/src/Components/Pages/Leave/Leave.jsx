...
const[data,setData]=useState({
  ...
  homeMobileNumber:"123467890",
  reason:"",
  userId:'65dae93a4f4351eef185bb8e'
});
...
<div className="relative z-0 w-full mb-5 group bg-rose-200 text-black rounded-lg">
      <input onChange={handleChange} type="name" name="name" id="name" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
  ...
  <div className="grid md:grid-cols-3 md:gap-6">
    ...
    <div className="relative z-0 w-full mb-5 group bg-rose-200 text-black rounded-lg">
        <input type="text" name="roomNumber" onChange={handleChange} id="floating_last_name" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
    ...
    <div className="relative z-0 w-full mb-5 group bg-rose-200 text-black rounded-lg">
        <input type="text" name="rollNumber" onChange={handleChange} id="floating_first_name" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
  ...
  <div class="relative z-0 w-full mb-5 group">
        <input type="tel" pattern="[0-9]{10}" name="mobileNumber" onChange={handleChange} id="floating_phone" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
